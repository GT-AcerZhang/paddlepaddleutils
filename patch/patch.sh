...
#path="https://raw.githubusercontent.com/gongweibao/Paddle/autorestorediff"
#path="https://raw.githubusercontent.com/PaddlePaddle/Paddle/release/1.8"
...
#path="https://raw.githubusercontent.com/gongweibao/Paddle/v1.8.2.1"
wget ${path}/python/paddle/fluid/incubate/fleet/collective/__init__.py -O python/paddle/fluid/incubate/fleet/collective/__init__.py
wget ${path}/python/paddle/fluid/incubate/fleet/utils/fleet_util.py -O python/paddle/fluid/incubate/fleet/utils/fleet_util.py
wget ${path}/python/paddle/fluid/incubate/fleet/utils/fs.py -O python/paddle/fluid/incubate/fleet/utils/fs.py
wget ${path}/python/paddle/fluid/tests/unittests/test_checkpoint_saver.py -O python/paddle/fluid/tests/unittests/test_checkpoint_saver.py

# diff
#gwb_path="https://raw.githubusercontent.com/gongweibao/Paddle/autorestorediff"
gwb_path=$path
...
#wget ${path}/python/paddle/fleet/utils/fs.py -O ./python/paddle/fluid/incubate/fleet/utils/fs.py
