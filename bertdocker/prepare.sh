...
#whl
cp ~/go/src/github.com/PaddlePaddle/Paddle/build/build_bertgather2_RelWithDebInfo_gpu/python/dist/paddlepaddle_gpu-0.0.0-cp27-cp27mu-linux_x86_64.whl whl/
